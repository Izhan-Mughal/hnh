          ...
          <div className="row mx-0 justify-content-center">
            <div className="col-xl-11 col-xxl-9">
              <div className="bg__dark rounded-5 pt-lg-0 pt-4 px-lg-0 px-3 ">
                <div className="row mx-0 gap-lg-0 gap-4 align-items-md-center align-items-xl-stretch">
                  <div className="col-lg-6">
                    <div className="ps-lg-5 py-lg-5">
                      ...
                      <div className="d-flex align-items-center gap-lg-3 gap-2 flex-xl-nowrap flex-wrap">
                        <input
                          type="text"
                          className="py-3 px-lg-5 px-3 border-0 rounded-pill w_100"
                          placeholder=" your email address"
                        />
                        <button className=" btn  rounded-pill whitespace text__light bg__green w_100 hover__green py-2 px-4">
                  ...
                  <div className="col-lg-6 pe-lg-0">
                    <img src={imgHands} className="img-fluid h-100" alt="" />
                  </div>
                </div>
              </div>
            </div>
